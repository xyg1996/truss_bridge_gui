...
class Ui_Computing_control(QDialog):
    ...
    def setupUi(self, dialog,working_dir_name = None,pimplefoam_root = None):
        ...
        self.Scotch_combo.addItem('off')
        self.Scotch_combo.addItem('on')
        ...
        self.groupBox_4.setTitle('自定义方法')
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.radioButton_2.setText('添加自定义方法')
...
probes
{
    ...
    def retranslateUi(self, dialog):
        ...
        self.label_5.setText(_translate("dialog", "最大库郎数:"))
        self.label_6.setText(_translate("dialog", "写入间隔:"))
    ...
    def col_control_res(self):
        ...
        key_list = computing_controldict_label_list
        value_list = computing_controldict_res_list
    ...
    def reload(self,dictionary):
        ...
        if 'is_parallel' in key_list:
            ...
            self.combobox.setCurrentText(value_list[5])
            self.combobox_2.setCurrentText(value_list[6])
            self.Scotch_combo.setCurrentText(value_list[7])
            if value_list[6] == 'scotch':
                self.Simple_widget.setVisible(False)
                self.Hierachical_widget.setVisible(False)
            if value_list[6] == 'simple':
                self.Simple_widget.setVisible(True)
                self.Hierachical_widget.setVisible(False)
                self.Simple_lineedit_1.setText(value_list[8])
                self.Simple_lineedit_4.setText(value_list[9])
            if value_list[6] == 'hierachical':
                self.Simple_widget.setVisible(False)
                self.Hierachical_widget.setVisible(True)
                self.Hierachical_lineedit_1.setText(value_list[8])
                self.Hierachical_lineedit_4.setText(value_list[9])
                self.Hierachical_lineedit_5.setText(value_list[10])
        else:
