...
class Ui_Workspace(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.width_lineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.length_lineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.height_lineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.sections_lineEdit = QtWidgets.QLineEdit(self.groupBox_6)
        self.spacing_lineEdit = QtWidgets.QLineEdit(self.groupBox_6)
