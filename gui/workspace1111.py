...
class Workspace(QWidget):
    ...
    def __init__(self, astergui, parent=None):
        ...
        self.work_space_tool.ui.pushButton_11.clicked.connect(self.start_computing)
        # 切换前处理、计算、后处理
    ...
    def show_mesh_check_res(self):
        ...
        self.process.start('sh '+ mesh_check_sh_working_dir + ' ' + self.workingdirectory)
        self.process.waitForFinished()
    ...
    def transfer_mash(self, workingdirectory):
        ...
        if unv_file:
            ...
            if workingdirectory:
                ...
                self.process.start('sh '+ mesh_tran_sh_working_dir + ' '+ self.workingdirectory)
                self.process.waitForFinished()
